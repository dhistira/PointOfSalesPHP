...
<head>
  ...
  <title>Edit Menu - <?= $this->session->userdata('tipe') == 1 ? 'Admin' : 'Kasir'; ?> Fremilt</title>
              ...
              <div class="col-6">
                <div class="card">
                  ...
                  <?php foreach($data as $b){?>
                    ...
                    <form method="post" action="<?= base_url(); ?>page/action_edit_menu/<?= $b->id ?>">
                      <div class="form-group">
                        <label>Nama Item</label>
                        <input type="text" name="namaitem" placeholder="Max 24 Karakter" class="form-control" value="<?= $b->nama_item;?>">
                      </div>
                      <div class="form-group">
                        <label>Detail Item (64 karakter)</label>
                        <input type="text" name="detailitem" placeholder="Max 64 Karakter" class="form-control" value="<?= $b->detail_item;?>">
                      </div>
                      <div class="form-group">
                        <label>Harga Item</label>
                        <input type="text" name="hargaitem" placeholder="Misal: 50000" value="<?= $b->harga_item;?>" class="form-control">
                      </div>
                      <div class="form-group">
